declare module $data {
    ...
    interface Queryable extends Object {
        filter(predicate:(it: any) => boolean): Queryable;
        filter(predicate:(it: any) => boolean, thisArg: any): Queryable;
        ...
        single(predicate: (it: any, params?: any) => boolean, params?: any, handler?: (result: any) => void): $data.IPromise;
        single(predicate: (it: any, params?: any) => boolean, params?: any, handler?: { success?: (result: any[]) => void; error?: (result: any) => void; }): $data.IPromise;
        ...
        first(predicate: (it: any, params?: any) => boolean, params?: any, handler?: (result: any) => void): $data.IPromise;
        first(predicate: (it: any, params?: any) => boolean, params?: any, handler?: { success?: (result: any[]) => void; error?: (result: any) => void; }): $data.IPromise;
