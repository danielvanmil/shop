declare module polymer {
    ...
    interface dom {
        (node: HTMLElement): PolymerHTMLElement;
        (node: polymer.Base): PolymerHTMLElement;
        flush(): any;
    }
    interface PolymerHTMLElement extends HTMLElement {
...
declare var Polymer: polymer.Polymer;
