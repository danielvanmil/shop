...
(function(global, $data, undefined) {
  ...
  /*Context Instance*/
  ODataWebV3.Northwind.Model.context = new ODataWebV3.Northwind.Model.NorthwindEntities( { name:'oData', oDataServiceHost: 'http://services.odata.org/Northwind/Northwind.svc' });
